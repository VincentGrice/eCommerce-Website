...
STRIPE_SECRET_KEY = os.environ.get("STRIPE_SECRET_KEY", "sk_test_aGSwbO1XiuQDV68Wp7Qq74X0")
STRIPE_PUB_KEY = os.environ.get("STRIPE_PUB_KEY", 'pk_test_OUtgrG1yqxLQmA9ooYYRI49n')
